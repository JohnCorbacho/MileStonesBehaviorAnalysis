      ...
      <div className="footer-container">
        <div className="footer-content">
          ...
          <div className="footer-section">
            ...
            <ul className="footer-links">
              <li><a href="#" className="footer-link">Early Intervention ABA</a></li>
              <li><a href="#" className="footer-link">School Readiness Programs</a></li>
              <li><a href="#" className="footer-link">Behavior Support Plans</a></li>
              <li><a href="#" className="footer-link">Social Skills Groups</a></li>
              <li><a href="#" className="footer-link">Parent Training</a></li>
            </ul>
          </div>
